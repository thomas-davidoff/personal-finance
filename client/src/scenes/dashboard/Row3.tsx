    ...
    return (
      ...
      data[0].monthlyData.map(({month, revenue, expenses}) => {
        return {
          name: month.substring(0, 3),
          revenue: parseInt(revenue.replace('$', '')),
          expenses: parseInt(expenses.replace('$', '')),
        }
      })
    )
  }, [data])
  ...
  return (
    <>
      ...
      <DashboardBox gridArea="h">
        <BoxHeader
          title="[PFD] Income vs. Expenses by Month"
          subtitle="graph displaying income vs expenses per month"
          sideText="+34%"
        />
        <ResponsiveContainer width="100%" height="100%">
          <BarChart
            ...
            <Bar dataKey="expenses" fill="url(#colorExpenses2)" />
          </BarChart>
        </ResponsiveContainer>
      </DashboardBox>
    </>
